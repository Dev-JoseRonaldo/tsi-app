...
import com.example.tsi_app.databinding.ActivitySignupBinding;
                    ...
                    if(password.equals(confirmPassword)){
                        ...
                        if(checkUserEmail == false){
                            ...
                            if(insert == true){
                                ...
                                Toast.makeText(SignupActivity.this, "Falha no cadastro!", Toast.LENGTH_SHORT).show();
                            }
                        }
                        else{
                            Toast.makeText(SignupActivity.this, "Usuário já existe! Faça o login", Toast.LENGTH_SHORT).show();
                        }
                    }else{
